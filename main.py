...
def welcome():
    ...
    while not exit_game:
        ...
        def text_scree(text, color, x, y):
            ...
            gameWindow.blit(screen_text, [x, y])
        text_scree("Credits", black, 700, 500)
        text_scree("Anupam Verma", black, 700, 530)
        text_scree("Pritam Das", black, 700, 550)
        ...
        if game_over:  
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    # Cheat - Add 10 points for every tapping of Q button
