...
image = pygame.image.load(r'pritam.jpg')
...
def game_loop():
    ...
    while not exit_game:                                   # our game window can be shown constant
        if game_over:
            ...
            i = pygame.image.load(r'gameover1.jpg')
            ...
            pygame.draw.rect(GameWindow, yellow, [food_x, food_y, food_size, food_size])  # draw a rectangle food
